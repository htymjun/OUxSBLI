#!/usr/bin/env bash
# SLAU-only Nsight Compute sweep.
#
# SLAU Riemann flux remains FP64. This sweep focuses on MUSCL/WENO left/right
# reconstruction split between native FP64 and DF emulation.
set -euo pipefail
...
ncu_run_case slau_muscl warp_u64_o6         slau_warp 6 6 fp64 fp64 fp64 df   fp64 df
ncu_run_case slau_muscl warp_p64_o6         slau_warp 6 6 fp64 fp64 fp64 df   df   fp64
...
ncu_run_case slau_weno warp_u64_o6          slau_weno_warp 6 6 fp64 fp64 fp64 df   fp64 df
ncu_run_case slau_weno warp_p64_o6          slau_weno_warp 6 6 fp64 fp64 fp64 df   df   fp64
