module mod_globals
  ...
  ! mesh
  real(8), parameter :: Lx = 240.d0 * blt !176!20
  real(8), parameter :: Ly = 100.d0 * blt !5
  ! DNS
  integer, parameter :: nx = 769 !2254!257
  integer, parameter :: ny = 641 !2049!129
  ...
  real(8), parameter :: endT  = 3.d-2 !8.d-3 !0.3d-3
  integer, parameter :: np    = 3000 !800 !30
  real(8), parameter :: R     = 287.15d0 !287.03d0
  real(8), parameter :: gamma = 1.4d0
  real(8), parameter :: M0    = 0.1 !2.15d0 !2
  ...
  real(8), parameter :: p2    = p0 !p0 * (1.d0 + 2.d0 * gamma * (Ms2 - 1.d0) / (gamma + 1.d0))
  real(8), parameter :: rho2  = rho0 !p2 / (R * T2)
  ...
  real(8), parameter :: ux    = u0 !u_magnitude * dcos(theta)
  real(8), parameter :: uy    = 0.d0 !- u_magnitude * dsin(theta)
